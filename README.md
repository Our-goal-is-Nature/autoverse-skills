...
```bash
npx skills update autoverse-cli autoverse-topic-prep autoverse-seed-expand -g -y
```
...
| `autoverse-seed-expand` | Expand from a specific paper into references, citations, and related work |
